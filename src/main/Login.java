...
public class Login {
	...
	private void initialize(Vector<Lego> legos) {
		...
		loginBtn.setStyle("-fx-background-color: gray;"
				+ "-fx-text-fill: white;"
				+ "-fx-font-size: 18px;"
				+ "-fx-min-width: 150px;");
		registerBtn.setStyle("-fx-background-color: gray;"
				+ "-fx-text-fill: white;"
				+ "-fx-font-size: 18px;"
				+ "-fx-min-width: 150px;");
		
		scene = new Scene(vbUtama, 1000, 700);
	}
...
//					System.out.println(i.getEmail() + i.getPassword() + "ini indexnya" + idx);
